...
def discriminator(input_img, label_size=10):
...
output_before_softmax_lab, xx_lab = discriminator(x_lab, label_size)
output_before_softmax_unl, xx_unl = discriminator(x_unl, label_size)
output_before_softmax_gen, xx_gen = discriminator(gen_dat, label_size) 
...
# test error
output_before_softmax, xx_lab = discriminator(x_lab, label_size)
...
train_gen_op = gen_param_updates.minimize(loss_gen, var_list=params_gen)
