...
output_before_softmax_lab, xx_lab = discriminator(x_lab)
output_before_softmax_unl, xx_unl = discriminator(x_unl)
output_before_softmax_gen, xx_gen = discriminator(gen_dat) 
...
# test error
output_before_softmax, xx_lab = discriminator(x_lab)
